...
DATABASES = {"default": env.db_url(default="django.db.backends.sqlite3://schema_api/db.sqlite3")}
...
if CLOUD_ENV.startswith("azure"):
    ...
    if AZURE_APPI_CONNECTION_STRING is not None:
        configure_azure_monitor(
            ...
            resource=Resource.create({ResourceAttributes.SERVICE_NAME: "django-base"}),
        )
